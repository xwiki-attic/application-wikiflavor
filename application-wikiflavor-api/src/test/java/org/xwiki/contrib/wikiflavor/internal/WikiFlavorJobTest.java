 ...
 * @version $Id: $
 */
public class WikiFlavorJobTest
{
    @Rule
    public MockitoComponentMockingRule<WikiFlavorJob> mocker = new MockitoComponentMockingRule<>(WikiFlavorJob.class);
    ...
    public void setUp() throws Exception
    {
        ...
        executionProvider = mocker.getInstance(new DefaultParameterizedType(null, Provider.class, Execution.class));
        when(executionProvider.get()).thenReturn(execution);
        executionContextManagerProvider = mocker.getInstance(new DefaultParameterizedType(null, Provider.class,
    ...
    public void runInternalWithException() throws Exception
    {
        ...
        WikiFlavorException exception = new WikiFlavorException("Error in the step");
        ...
        verify(mocker.getMockedLogger()).error(any(Marker.class), eq("Exception thrown during job execution"),
                eq(new WikiFlavorException("Failed to execute creation steps on the wiki [wikiId].", exception)));
    }
    
    @Test
    public void getType() throws Exception
    {
        assertEquals("wikiflavorjob", mocker.getComponentUnderTest().getType());
    }
}
